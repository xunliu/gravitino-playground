...
curl -iv -u admin:rangerR0cks! -d @./hiveDev.json -H "Content-Type: application/json" -X POST http://ranger:6080/service/public/v2/api/service


curl -iv -u admin:rangerR0cks! -d @./hdfsDev.json -H "Content-Type: application/json" -X POST http://ranger:6080/service/public/v2/api/service
